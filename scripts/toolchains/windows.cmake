...
if(NOT _CMAKE_IN_TRY_COMPILE)
    ...
    set(CMAKE_CXX_FLAGS " /nologo /DWIN32 /D_WINDOWS /W3 /guard:cf ${CHARSET_FLAG} /GR /EHsc /MP ${VCPKG_CXX_FLAGS}" CACHE STRING "")
    set(CMAKE_C_FLAGS " /nologo /DWIN32 /D_WINDOWS /W3 /guard:cf ${CHARSET_FLAG} /MP ${VCPKG_C_FLAGS}" CACHE STRING "")
